    ...
    private void addCalories(){
        if (getActivity() != null) {
            ...
            SharedPreferences.Editor editor = getActivity().getSharedPreferences(
                        "foodCalory", Context.MODE_PRIVATE).edit();
                editor.putInt("foodCalory",foodCalory);
                editor.apply();
                SharedPreferences a =  getActivity().getSharedPreferences("foodCalory",Context.MODE_PRIVATE);
                int aq = a.getInt("foodCalory",0);
                int bq = a.getInt("totalCalory",0);
                bq += aq;editor.putInt("totalCalory",bq);
                editor.apply();
                switchPreviousPage();
