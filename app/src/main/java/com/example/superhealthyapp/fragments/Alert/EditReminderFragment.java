...
import com.example.superhealthyapp.managers.NotificationReceiverManager;
...
import com.example.superhealthyapp.managers.AlertReceiverManager;
        ...
        if(getActivity() != null) {
            if (getActivity().getIntent().getExtras() != null) {
                ...
                Cursor cursor = sqLiteDatabase.rawQuery("select * from " + ReminderDatabase.TABLE_NAME + " where " +
                        ReminderDatabase.KEY_ID + "=" + id, null);
                if (cursor != null) {
        ...
        if(getActivity() != null) {
            if(getActivity().getIntent().getExtras() != null) {
                ...
                if (radioAlarm.isChecked()) {
                    ...
                    Intent intent = new Intent(getContext(), AlertReceiverManager.class);
                    ...
                    AlarmManager alarmManager = (AlarmManager) getActivity().getSystemService(Context.ALARM_SERVICE);
                    Intent intent = new Intent(getContext(), NotificationReceiverManager.class);
