...
import com.example.superhealthyapp.Services.ShutdownReceiver;
import com.example.superhealthyapp.databases.StepCounterDatabase;
import com.example.superhealthyapp.managers.DateManager;
/*
https://github.com/j4velin/Pedometer/blob/master/src/main/java/de/j4velin/pedometer/SensorListener.java
 */
...
public class SensorListener extends Service implements SensorEventListener {
    ...
    private void updateIfNecessary() {
        if (steps > lastSaveSteps + SAVE_OFFSET_STEPS ||
            ...
            if (db.getSteps(DateManager.getToday()) == Integer.MIN_VALUE) {
                ...
                db.insertNewDay(DateManager.getToday(), steps - pauseDifference);
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
        ...
        long nextUpdate = Math.min(DateManager.getTomorrow(),
