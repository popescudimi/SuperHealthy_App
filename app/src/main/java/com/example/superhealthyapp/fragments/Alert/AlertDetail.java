        ...
        if (getActivity() != null) {
            if (getActivity().getIntent().getExtras() != null) {
                ...
                Cursor cursor = sqLiteDatabase.rawQuery
                        ("select * from " + ReminderDatabase.TABLE_NAME + " where " + ReminderDatabase.KEY_ID+ "=" + rowId, null);
    ...
    private void deleteSelectedVariable() {
        if (getActivity() != null) {
            if (getActivity().getIntent().getExtras() != null) {
                ...
                sqLiteDatabase.delete(ReminderDatabase.TABLE_NAME, ReminderDatabase.KEY_ID + "=" + id, null);
